...
The Multi-Blockchain Wallet is a tool created using Python Libraries to generate accounts, and send transactions.

The code below in this project supports BTC-TEST and ETH
...
- Create a file called `wallet.py` -- this will be your universal wallet script. You can use [Wallet.py](Wallet/wallet.py)
...
- You'll need to set the account with  `priv_key_to_account` and use `send_tx` to send transactions.
  ...
  - **Bitcoin Testnet transaction**
    ...
    - Screenshot the confirmation of the transaction like so:
      ...
      ![btc-test](Images/btc-test-console.png)
      
      To validate the transactions you can visit:
      [btc-test ](https://tbtc.bitaps.com/n1ccXXdtqS8EPA5LNh2zAu2CTS6eMbikXK)

      ![btc-test](Images/btc-test-tx.png)
  ...
  - **Local PoA Ethereum transaction**
    ...
    - Send a transaction from the pre-funded address within the wallet to another, then copy the `txid` into
      ...
      ![btc-test](Images/eth-console.png)
      
      ![btc-test](Images/eth-tx.png)